...
**Оплаты здесь нет намеренно.** Читать баланс, историю и чеки, выписывать счета —
безопасно. Нажать «заплатить» за человека — нет: сумму подтверждают на своём
экране, а не в скрипте.
...
bin/tgx_pay.py      звёзды, TON и счета — чтение и выписка, без оплаты
